...
//   $this->syncUsers();
 ...
 public function syncClientOutcomes() {
  ...
  $client_outcomes              = ClientOutcome::join('tbl_client', 'tbl_clnt_outcome.client_id', '=', 'tbl_client.id')->where('id', '>', $max_exisiting_client_outcome)->where('tbl_client.partner_id', 18)->get();
