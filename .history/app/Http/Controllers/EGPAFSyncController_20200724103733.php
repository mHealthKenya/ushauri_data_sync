...
class EGPAFSyncController extends Controller
{
    ...
    public function syncUsers()
    {
        ...
        $users = User::where('partner_id', 1)->where('id', '>', $max_exisiting_user)->get();
        ...
        $updates_users = User::where('partner_id', 1)->where('updated_at', '>', Carbon::now()->subDays(1))->get();
    ...
    public function syncClients()
    {
        ...
        $clients = Client::where('partner_id', 1)->where('id', '>', $max_exisiting_client)->get();
        ...
        $updates_availables = Client::where('partner_id', 1)->where('updated_at', '>', Carbon::now()->subDays(1))->get();
